...
Calculate the build number as: **current date (YYYYMMDD) + 30**

Example: If today is `20260113`, the build number is `20260143`

```bash
# Calculate build number
DATE=$(date +%Y%m%d)
BUILD_NUMBER=$((DATE + 30))
...
1. Build number = `20260113 + 30` = `20260143`
2. Create branch `9005.20.0`
3. Set VERSION=`9005.20.0` in `.env.version`
4. Hardcode BUILD_NUMBER=`20260143` in shared-env action
5. Hardcode BUILD_NUMBER=`20260143` in release-android workflow
6. Set versionCode=`20260143`, versionName=`"9005.20.0"` in build.gradle
7. Commit and push
