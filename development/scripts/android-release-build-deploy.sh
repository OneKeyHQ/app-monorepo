...
cmd_deploy() {
  local FORCE_INSTALL_APK="${1:-false}"
  local DEVICE_ID
  ...
  # A full release build must install the APK it just produced. The APK already
  # contains the union HBC assets generated by Gradle.
  if [ "$FORCE_INSTALL_APK" = "true" ]; then
    echo "   Installing freshly built release APK..."
