...
4. Compare actual decisions and supporting evidence. Keep the raw outputs with the maintenance record; do not convert one run per variant into a statistical success rate or infer full-file token consumption from a filename list.
