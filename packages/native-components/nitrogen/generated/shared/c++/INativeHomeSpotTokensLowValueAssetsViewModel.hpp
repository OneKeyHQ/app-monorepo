///
/// INativeHomeSpotTokensLowValueAssetsViewModel.hpp
...
namespace margelo::nitro::onekeynativecomponents {
  ...
  /**
   * A struct which can be represented as a JavaScript object (INativeHomeSpotTokensLowValueAssetsViewModel).
   */
  struct INativeHomeSpotTokensLowValueAssetsViewModel final {
  public:
  ...
  public:
    INativeHomeSpotTokensLowValueAssetsViewModel() = default;
    explicit INativeHomeSpotTokensLowValueAssetsViewModel(bool visible, std::string title, std::string valueText, bool enabled): visible(visible), title(title), valueText(valueText), enabled(enabled) {}

  public:
    friend bool operator==(const INativeHomeSpotTokensLowValueAssetsViewModel& lhs, const INativeHomeSpotTokensLowValueAssetsViewModel& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ INativeHomeSpotTokensLowValueAssetsViewModel <> JS INativeHomeSpotTokensLowValueAssetsViewModel (object)
  template <>
  struct JSIConverter<margelo::nitro::onekeynativecomponents::INativeHomeSpotTokensLowValueAssetsViewModel> final {
    static inline margelo::nitro::onekeynativecomponents::INativeHomeSpotTokensLowValueAssetsViewModel fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::onekeynativecomponents::INativeHomeSpotTokensLowValueAssetsViewModel(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::onekeynativecomponents::INativeHomeSpotTokensLowValueAssetsViewModel& arg) {
