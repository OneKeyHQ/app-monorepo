///
/// INativeHomePortfolioLowValueAssetsViewModel.hpp
...
namespace margelo::nitro::onekeynativecomponents {
  ...
  /**
   * A struct which can be represented as a JavaScript object (INativeHomePortfolioLowValueAssetsViewModel).
   */
  struct INativeHomePortfolioLowValueAssetsViewModel final {
  public:
  ...
  public:
    INativeHomePortfolioLowValueAssetsViewModel() = default;
    explicit INativeHomePortfolioLowValueAssetsViewModel(bool visible, std::string title, std::string valueText, bool enabled): visible(visible), title(title), valueText(valueText), enabled(enabled) {}

  public:
    friend bool operator==(const INativeHomePortfolioLowValueAssetsViewModel& lhs, const INativeHomePortfolioLowValueAssetsViewModel& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ INativeHomePortfolioLowValueAssetsViewModel <> JS INativeHomePortfolioLowValueAssetsViewModel (object)
  template <>
  struct JSIConverter<margelo::nitro::onekeynativecomponents::INativeHomePortfolioLowValueAssetsViewModel> final {
    static inline margelo::nitro::onekeynativecomponents::INativeHomePortfolioLowValueAssetsViewModel fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::onekeynativecomponents::INativeHomePortfolioLowValueAssetsViewModel(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::onekeynativecomponents::INativeHomePortfolioLowValueAssetsViewModel& arg) {
