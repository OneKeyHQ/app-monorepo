///
/// INativeHomePortfolioRiskAssetsViewModel.hpp
...
namespace margelo::nitro::onekeynativecomponents {
  ...
  /**
   * A struct which can be represented as a JavaScript object (INativeHomePortfolioRiskAssetsViewModel).
   */
  struct INativeHomePortfolioRiskAssetsViewModel final {
  public:
  ...
  public:
    INativeHomePortfolioRiskAssetsViewModel() = default;
    explicit INativeHomePortfolioRiskAssetsViewModel(bool visible, std::string title, bool enabled): visible(visible), title(title), enabled(enabled) {}

  public:
    friend bool operator==(const INativeHomePortfolioRiskAssetsViewModel& lhs, const INativeHomePortfolioRiskAssetsViewModel& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ INativeHomePortfolioRiskAssetsViewModel <> JS INativeHomePortfolioRiskAssetsViewModel (object)
  template <>
  struct JSIConverter<margelo::nitro::onekeynativecomponents::INativeHomePortfolioRiskAssetsViewModel> final {
    static inline margelo::nitro::onekeynativecomponents::INativeHomePortfolioRiskAssetsViewModel fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::onekeynativecomponents::INativeHomePortfolioRiskAssetsViewModel(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::onekeynativecomponents::INativeHomePortfolioRiskAssetsViewModel& arg) {
