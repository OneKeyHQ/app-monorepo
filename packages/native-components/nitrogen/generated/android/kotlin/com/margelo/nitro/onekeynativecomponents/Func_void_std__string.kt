...
/**
 * Represents the JavaScript callback `(tabId: string) => void`.
...
fun interface Func_void_std__string: (String) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(tabId: String): Unit
}
...
class Func_void_std__string_cxx: Func_void_std__string {
  ...
  @FastNative
  private external fun invoke_cxx(tabId: String): Unit
}
