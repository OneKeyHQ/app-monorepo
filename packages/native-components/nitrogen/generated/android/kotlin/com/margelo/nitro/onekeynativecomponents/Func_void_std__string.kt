...
/**
 * Represents the JavaScript callback `(intentJson: string) => void`.
...
fun interface Func_void_std__string: (String) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(intentJson: String): Unit
}
...
class Func_void_std__string_cxx: Func_void_std__string {
  ...
  @Keep
  override fun invoke(intentJson: String): Unit
    = invoke_cxx(intentJson)

  @FastNative
  private external fun invoke_cxx(intentJson: String): Unit
}
...
class Func_void_std__string_java(private val function: (String) -> Unit): Func_void_std__string {
  ...
  @Keep
  override fun invoke(intentJson: String): Unit {
    return this.function(intentJson)
  }
}
