...
RCT_EXPORT_VIEW_PROPERTY(presentStyle, NSDictionary);
RCT_EXPORT_VIEW_PROPERTY(thumbStyle, NSDictionary);
...
//
//RCT_CUSTOM_VIEW_PROPERTY(presentStyle, NSDictionary, RNCSlider)
//{
//  if (json) {
//    [view setPresentStyle: [RCTConvert NSDictionary:json]];
//  } else {
//    [view setPresentStyle: nil];
//  }
//}
