...
describe('Stacks Utils Tests', () => {
  it('Stacks Utils signEncodedTx #1', async () => {
    const signedTx = await signEncodedTx(
      {
        ...
        'encodedTx': {
          ...
          'outputs': [
            {
              'address':
                'stackstest:nqtsq5g5wud2fr7l32as0mfzms3hwnz7dxvsc2h8szatr5p8',
              'satoshis': '5000',
              'outType': 1,
            },
          ],
          'gas': undefined,
          'transferInfo': {
            'from': 'stackstest:nqtsq5g5llmjhut9fuzst4993zmk62m89rw2gztuvl376dp0',
            'to': 'stackstest:nqtsq5g5wud2fr7l32as0mfzms3hwnz7dxvsc2h8szatr5p8',
            'amount': '50',
          },
        },
      },
  ...
  it('Stacks Utils signEncodedTx #2', async () => {
    const signedTx = await signEncodedTx(
      {
        'inputs': [],
        'outputs': [],
        ...
        'encodedTx': {
          'inputs': [
            {
              ...
              'satoshis': '99758530',
              'address':
                'stackstest:nqtsq5g5l7rgf6mrvuhrjke8vsm4ng60q86vdycptqn79epv',
            },
            {
              'txId':
          ...
          'gas': undefined,
          'transferInfo': {
            'from': 'stackstest:nqtsq5g5l7rgf6mrvuhrjke8vsm4ng60q86vdycptqn79epv',
            'to': 'stackstest:nqtsq5g5wud2fr7l32as0mfzms3hwnz7dxvsc2h8szatr5p8',
            'amount': '50',
          },
        },
  ...
  it('Stacks Utils signEncodedTx #3: Transfer out all the balances.', async () => {
    const signedTx = await signEncodedTx(
      {
        'inputs': [],
        'outputs': [],
        ...
        'encodedTx': {
          'inputs': [
            {
              ...
              'satoshis': '20000',
              'address':
                'stackstest:nqtsq5g5skxwlgtmsl99hj6tt8hmsa52cxft09um2md36p07',
            },
            {
              'txId':
          ...
          'outputs': [
            {
              'address':
                'stackstest:nqtsq5g50frur0vav60gupjlrr8cta8vyqufu7p9gskt92mz',
              'satoshis': '90000',
              'outType': 1,
            },
          ],
          'transferInfo': {
            'from': 'stackstest:nqtsq5g5skxwlgtmsl99hj6tt8hmsa52cxft09um2md36p07',
            'to': 'stackstest:nqtsq5g50frur0vav60gupjlrr8cta8vyqufu7p9gskt92mz',
            'amount': '900',
          },
          'gas': '2409',
        },
  ...
  it('Stacks Utils decodeScriptHexToStacksAddress #1', () => {
    const hex =
    ...
    expect(
      decodeScriptBufferToStacksAddress(Buffer.from(hex, 'hex'), 'stackstest'),
    ).toBe('stackstest:nqtsq5g5l7rgf6mrvuhrjke8vsm4ng60q86vdycptqn79epv');
  });

  it('Stacks Utils decodeScriptHexToStacksAddress #2', () => {
    const hex = '005114345209375631d693fca3865141cc6de052e11797';
    expect(
      decodeScriptBufferToStacksAddress(Buffer.from(hex, 'hex'), 'stackstest'),
    ).toBe('stackstest:nqtsq5g5x3fqjd6kx8tf8l9rseg5rnrdupfwz9uhauzga026');
  });

  it('Stacks Utils Sgin Transaction', () => {
    const privateKey =
  ...
  it('Stacks buildDecodeTxFromTx test', () => {
    const testData0 = {
      'tx': {
        'blockhash':
      ...
      'dbAccountAddress':
        'Stacks:nqtsq5g50nmzhzsnzjc9ncjaq6jyrcpd43z962rjffhrvpe0',
      'addressPrefix': 'Stacks',
      'decimals': 2,
      'token': {
        'id': 'Stacks--0',
        'name': 'NEX',
        ...
        'symbol': 'NEX',
        'decimals': 2,
        'logoURI': 'https://onekey-asset.com/assets/Stacks/Stacks.png',
        'impl': 'Stacks',
        'chainId': '0',
        'address': '',
        'source': '',
    ...
    expect(buildDecodeTxFromTx(testData0)).toEqual({
      ...
      'actions': [
        {
          ...
          'tokenTransfer': {
            ...
            'amountValue': '329.77',
            'extraInfo': null,
            'from': 'Stacks:nqtsq5g5xa04uklfmhm3nkrr2vrxv0reqw6npkatl7dx7fjz',
            'to': 'Stacks:nqtsq5g50nmzhzsnzjc9ncjaq6jyrcpd43z962rjffhrvpe0',
            'tokenInfo': {
              'address': '',
              'chainId': '0',
              'decimals': 2,
      ...
      'owner': 'Stacks:nqtsq5g50nmzhzsnzjc9ncjaq6jyrcpd43z962rjffhrvpe0',
      'signer': 'Stacks:nqtsq5g5xa04uklfmhm3nkrr2vrxv0reqw6npkatl7dx7fjz',
      'status': 'Confirmed',
    ...
    expect(buildDecodeTxFromTx(testData2)).toEqual({
      ...
      'actions': [
        {
          ...
          'tokenTransfer': {
            ...
            'extraInfo': null,
            'from': 'Stacks:nqtsq5g50nmzhzsnzjc9ncjaq6jyrcpd43z962rjffhrvpe0',
            'to': 'Stacks:nqtsq5g5acvea452hndyzwwggw2jwzq08f4wuwljenjtdvhc',
            'tokenInfo': {
              'address': '',
              'chainId': '0',
              'decimals': 2,
      ...
      'owner': 'Stacks:nqtsq5g50nmzhzsnzjc9ncjaq6jyrcpd43z962rjffhrvpe0',
      'signer': 'Stacks:nqtsq5g50nmzhzsnzjc9ncjaq6jyrcpd43z962rjffhrvpe0',
      'status': 'Confirmed',
      'totalFeeInNative': '6.57',
      'txid':
        '527224633117cd391a361b1781a8693ddf0bfa8cd5cd3e74f82501cb359c0339',
    ...
    const testData3 = {
      ...
      'dbAccountAddress':
        'Stacks:nqtsq5g5xa04uklfmhm3nkrr2vrxv0reqw6npkatl7dx7fjz',
      'addressPrefix': 'Stacks',
      'decimals': 2,
      'token': {
        'id': 'Stacks--0',
    ...
    expect(buildDecodeTxFromTx(testData3)).toEqual({
      ...
      'actions': [
        {
          ...
          'tokenTransfer': {
            ...
            'extraInfo': null,
            'from': 'Stacks:nqtsq5g5xa04uklfmhm3nkrr2vrxv0reqw6npkatl7dx7fjz',
            'to': 'Stacks:nqtsq5g5xa04uklfmhm3nkrr2vrxv0reqw6npkatl7dx7fjz',
            'tokenInfo': {
              'address': '',
              'chainId': '0',
              'decimals': 2,
      ...
      'owner': 'Stacks:nqtsq5g5xa04uklfmhm3nkrr2vrxv0reqw6npkatl7dx7fjz',
      'signer': 'Stacks:nqtsq5g5xa04uklfmhm3nkrr2vrxv0reqw6npkatl7dx7fjz',
      'status': 'Confirmed',
      'totalFeeInNative': '6.57',
      'txid':
