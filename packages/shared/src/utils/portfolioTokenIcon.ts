...
const PORTFOLIO_TOKEN_CANONICAL_NAMES: Record<IPortfolioTokenIconName, string> =
  {
    BNB: 'BNB',
    BTC: 'Bitcoin',
    ETH: 'Ethereum',
...
export function getPortfolioTokenCanonicalName(
  iconName: IPortfolioTokenIconName,
): string {
  return PORTFOLIO_TOKEN_CANONICAL_NAMES[iconName];
}
