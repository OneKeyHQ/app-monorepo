...
export const KEYLESS_SYNC_ENCRYPTION_SALT = 'B2C4D6E8-1A3B-5C7D-9E1F-4A6B8C0D2E4F';

// Credential storage encryption (fixed key for obfuscation)
export const KEYLESS_SYNC_CREDENTIAL_STORAGE_KEY = 'D1E2F3A4-B5C6-7D8E-9F0A-1B2C3D4E5F6A';
export const KEYLESS_SYNC_CREDENTIAL_STORAGE_AAD = '8A9B0C1D-2E3F-4A5B-6C7D-8E9F0A1B2C3D';
