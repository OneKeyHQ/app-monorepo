...
export const BundleUpdate: IBundleUpdate = {
  ...
  testDeleteJsBundle: () => Promise.resolve({ success: false, message: 'Not supported on web' }),
  testDeleteJsRuntimeDir: () => Promise.resolve({ success: false, message: 'Not supported on web' }),
  testDeleteMetadataJson: () => Promise.resolve({ success: false, message: 'Not supported on web' }),
  testWriteEmptyMetadataJson: () => Promise.resolve({ success: false, message: 'Not supported on web' }),
};
