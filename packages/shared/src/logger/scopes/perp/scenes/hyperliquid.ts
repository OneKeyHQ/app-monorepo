...
export type IHyperLiquidSubscriptionDiagnosticParams = {
  ...
  activeAssetCoinSet?: boolean;
  spotActiveAssetCoinSet?: boolean;
  activeAssetIdSet?: boolean;
  spotActiveAssetIdSet?: boolean;
  currentAssetIdSet?: boolean;
  orderBookCoinMatchesCurrent?: boolean;
  coinMatched?: boolean;
  currentBookCoinSet?: boolean;
  updateApplied?: boolean;
  snapshotAllDexsSet?: boolean;
  snapshotL2BookSet?: boolean;
  assetCtxDexCount?: number;
  assetCtxPerpCount?: number;
  assetCtxXyzCount?: number;
  l2BookSideCount?: number;
  l2BookBidCount?: number;
  l2BookAskCount?: number;
  ageMs?: number;
  claimed?: boolean;
  nextCoinSet?: boolean;
