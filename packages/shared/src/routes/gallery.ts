export enum EGalleryRoutes {
  ...
  ComponentQRWallet = 'component-a-QrWallet',
  ...
  ComponentSecretHash = 'component-secretHash',
  ComponentSecretCryptoFunction = 'component-secretCryptoFunction',
}
