...
const marketTradeDefaultSetETH = {
  'networkId': 'evm--1',
  'contractAddress': '',
  'name': 'Ethereum',
  'symbol': 'ETH',
...
const marketTradeDefaultSetUSDC = {
  'networkId': 'evm--1',
...
const marketTradeDefaultSetSOL = {
  'networkId': 'sol--101',
...
export function getImportFromToken({
  ...
  switch (networkId) {
    ...
    case networkIdsMap.sbtc:
      importFromToken = marketTradeDefaultSetETH;
    ...
    case networkIdsMap.sepolia: {
      if (tokenSymbol === 'MATIC') {
        ...
        importFromToken = marketTradeDefaultSetUSDC;
      }
      swapTabSwitchType = ESwapTabSwitchType.SWAP;
      break;
    }
    case networkIdsMap.sol: {
      importFromToken = marketTradeDefaultSetSOL;
      swapTabSwitchType = ESwapTabSwitchType.SWAP;
      break;
    }
