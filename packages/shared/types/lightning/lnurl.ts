export type ILNURLError = {
  status: 'ERROR';
  reason: string;
};

export type ILNURLDetails =
  | ILNURLChannelServiceResponse
  | ILNURLPayServiceResponse
  | ILNURLAuthServiceResponse
  | ILNURLWithdrawServiceResponse;

export interface ILNURLPayServiceResponse {
...
export interface ILNURLAuthServiceResponse {
...
export interface ILNURLWithdrawServiceResponse {
...
export interface ILNURLChannelServiceResponse {
...
export interface ILNURLPaymentInfo {
  pr: string;
  successAction?: ILNURLPaymentSuccessAction;
}

export interface ILNURLPaymentSuccessAction {
  tag: string;
  description?: string;
  message?: string;
  url?: string;
...
export type ILnurlAuthResponse = {
  success: boolean;
  status: string;
  reason?: string;
