...
import type { IOnHoverFunction } from '@onekeyhq/kit/src/views/Market/components/Chart/chartUtils';
import platformEnv from '@onekeyhq/shared/src/platformEnv';

export default function EarnChartWrapper({
  isFetching,
  width,
  height,
  lineColor,
  ...
  return (
    <YStack position="relative" height={height} overflow="hidden">
      <ChartPath
        fill="none"
