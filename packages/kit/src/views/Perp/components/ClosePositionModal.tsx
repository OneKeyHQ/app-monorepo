    ...
    <YStack gap="$4">
      ...
      <YStack gap="$3" bg="$bgSubdued" borderRadius="$3" p="$3">
        ...
        <XStack justifyContent="space-between" alignItems="center">
          ...
          <SizableText size="$bodyMd" fontWeight="500">
            ${price > 0 ? formatPriceToSignificantDigits(price, 5) : 'Loading...'}
          </SizableText>
        </XStack>
      </YStack>
...
export function showClosePositionDialog({
  ...
  console.log('ClosePositionModal showClosePositionDialog:', {
    positionCoin: position.coin,
    mid,
    assetId,
    hasHyperliquidActions: !!hyperliquidActions
  });
