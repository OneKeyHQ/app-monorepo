...
import { TabSwitcher } from '../UnifiedNetworkSelector/TabSwitcher';
...
const UnifiedNetworkSelectorMemoV2 = memo(UnifiedNetworkSelectorV2);

export default function UnifiedNetworkSelectorPageV2() {
  const route =
    useRoute<
      RouteProp<
        IChainSelectorParamList,
