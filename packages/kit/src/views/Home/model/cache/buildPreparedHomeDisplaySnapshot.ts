...
import type { IHomeDisplaySnapshotCritical } from './homeDisplaySnapshotTypes';
...
export function buildPreparedHomeDisplaySnapshot({
  critical,
  records,
}: {
  critical: IHomeDisplaySnapshotCritical | undefined;
  records: readonly IHomeCachedSourceRecord[];
