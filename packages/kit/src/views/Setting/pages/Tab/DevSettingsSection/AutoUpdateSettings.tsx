    ...
    Dialog.show({
      ...
      renderContent: (
        <YStack p="$4" gap="$4">
          ...
          <YStack gap="$3">
            <SizableText size="$headingSm">Version Configuration</SizableText>
            <Input
          ...
          {(platformEnv.isNativeAndroid ||
            ...
            <>
              <YStack gap="$3">
                <SizableText size="$headingSm">Auto Update Failed Tests</SizableText>
                <YStack gap="$2">
                  <Button
                    variant="secondary"
                    onPress={() => {
          ...
          {/* Verification Tests */}
          <YStack gap="$3">
            <SizableText size="$headingSm">Verification Tests</SizableText>
            <Button
              variant="primary"
              onPress={async () => {
                try {
          ...
          {/* Bundle Tests */}
          <YStack gap="$3">
            <SizableText size="$headingSm">Bundle Tests</SizableText>
            <YStack gap="$2">
              <Button
                variant="secondary"
                onPress={async () => {
