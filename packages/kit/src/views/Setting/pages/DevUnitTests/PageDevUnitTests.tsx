...
const CRYPTO_TEST_SNAPSHOTS = {
  keyFromPasswordAndSalt: '2e90bd72bd2580bdf52e85ff316a3b551fa8c9133bc92a5ada7ba1e7f452df02',
...
export default function PageDevUnitTests() {
  ...
  const [saltHex, setSaltHex] = useState(Buffer.alloc(PBKDF2_SALT_LENGTH, 'a').toString('hex'));
  ...
  const [decryptIvHex, setDecryptIvHex] = useState(Buffer.alloc(AES256_IV_LENGTH, 'd').toString('hex'));
  const [decryptKeyHex, setDecryptKeyHex] = useState(Buffer.alloc(PBKDF2_KEY_LENGTH, 'c').toString('hex'));
          ...
          <Stack space="$4">
            ...
            <Stack direction="ltr" alignItems="center" space="$2">
              ...
              {hmac256Valid !== undefined && (
                <Icon
                  name={hmac256Valid ? "TxStatusSuccessCircleIllus" : "TxStatusFailureCircleIllus"}
          ...
          <Stack space="$4">
            ...
            <Stack direction="ltr" alignItems="center" space="$2">
              ...
              {hmac512Valid !== undefined && (
                <Icon
                  name={hmac512Valid ? "TxStatusSuccessCircleIllus" : "TxStatusFailureCircleIllus"}
          ...
          <Stack space="$4">
            ...
            <Stack direction="ltr" alignItems="center" space="$2">
              ...
              {sha256Valid !== undefined && (
                <Icon
                  name={sha256Valid ? "TxStatusSuccessCircleIllus" : "TxStatusFailureCircleIllus"}
          ...
          <Stack space="$4">
            ...
            <Stack direction="ltr" alignItems="center" space="$2">
              ...
              {hash160Valid !== undefined && (
                <Icon
                  name={hash160Valid ? "TxStatusSuccessCircleIllus" : "TxStatusFailureCircleIllus"}
          ...
          <Stack space="$4">
            ...
            <Stack direction="ltr" alignItems="center" space="$2">
              ...
              {derivedKeyValid !== undefined && (
                <Icon
                  name={derivedKeyValid ? "TxStatusSuccessCircleIllus" : "TxStatusFailureCircleIllus"}
          ...
          <Stack space="$4">
            ...
            <Stack direction="ltr" alignItems="center" space="$2">
              ...
              {encryptedValid !== undefined && (
                <Icon
                  name={encryptedValid ? "TxStatusSuccessCircleIllus" : "TxStatusFailureCircleIllus"}
          ...
          <Stack space="$4">
            ...
            <Stack direction="ltr" alignItems="center" space="$2">
              ...
              {decryptedValid !== undefined && (
                <Icon
                  name={decryptedValid ? "TxStatusSuccessCircleIllus" : "TxStatusFailureCircleIllus"}
