...
describe('TradingViewNative chart constants', () => {
  ...
  it('uses the project monospace font for price-axis labels', () => {
    expect(TRADING_VIEW_NATIVE_PRICE_AXIS_FONT_SIZE).toBe(11);
  ...
  it('uses a smaller time-axis font in compact charts', () => {
    expect(TRADING_VIEW_NATIVE_COMPACT_TIME_AXIS_FONT_SIZE).toBe(11);
    expect(TRADING_VIEW_NATIVE_COMPACT_TIME_AXIS_HEIGHT).toBe(20);
  });
});
