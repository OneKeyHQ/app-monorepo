...
import { Button, Form, Stack, Text, useForm } from '@onekeyhq/components';
...
const Validation: FC<ValidationProps> = ({
  ...
  const onSubmit = useFormReturn.handleSubmit(async (values: FieldValues) => {
    const key =
  ...
  //         <Stack testID="Validation" w="full" h="full" bg="background-default">
  //           <Stack
  //             // maxW="96"
  //             w="full"
  //             h="full"
