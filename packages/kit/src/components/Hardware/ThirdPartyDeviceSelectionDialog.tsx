...
export function showThirdPartyDeviceSelectionDialog({
  ...
  return Dialog.show({
    ...
    showFooter: false,
    // The pairing code is asked on the DeviceStage, which rises over this
    // dialog outside its DOM: a trapped focus scope would pull focus straight
    // back out of that input (OK-63224). Nothing in this list needs the trap.
    trapFocus: false,
    renderContent: (
