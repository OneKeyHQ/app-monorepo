...
describe('travelModeCommandPolicy', () => {
  ...
  it.each([
    ...
    ['serviceMarket', 'fetchMarketAssetList'],
    ...
    ['serviceMarketV2', 'fetchMarketStockBatch'],
    ['serviceMarketV2', 'fetchMarketStockList'],
    ['serviceMarketV2', 'fetchMarketPerpsTokenList'],
    ...
    ['serviceStaking', 'getAvailableAssets'],
    ['serviceStaking', 'getAvailableAssetsV2'],
    ['serviceStaking', 'getBlockRegion'],
    ['serviceStaking', 'getEarnPageBannerList'],
    ['serviceStaking', 'getEarnPageBannerListFromCache'],
    ['serviceStaking', 'getFAQListForHome'],
