...
const styles = StyleSheet.create({
  ...
  // one view cannot both cast and clip. The web wears the design's
  // layered CSS shadow and a 1px outline instead — an outline paints
  // outside the box (and follows the border radius), so no ring view is
  // needed there; the native hairline lives on `ring` below. Both edge
  // colors resolve from the ambient theme at render.
  shell: {
