...
import { useDomID } from '../../hooks/useClickDocumentClose';
...
function DesktopWithRef<T>() {
  return React.forwardRef<DesktopRef, ChildProps<T>>(
    (
      {
        dropdownProps,
        toggleVisible,
      ...
      const { domId } = useDomID('SelectDesktop');
      // 增加此处的ref
...
/* eslint-disable react/prop-types,react/display-name */
DesktopWithRef.displayName = 'DesktopWithRef';

export default DesktopWithRef;
