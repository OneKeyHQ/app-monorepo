...
const SvgNexa = (props: SvgProps) => (
  <Svg fill="none" viewBox="0 0 16 16" accessibilityRole="image" {...props}>
    ...
    <Path fill="#8C8CA1" d="M7.982 10.776 2 4.28l5.982 9.905v-3.408Z" />
    <Path
      fill="#8C8CA1"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <Path fill="#8C8CA1" d="m7.991 5.257 2.48-2.675L7.99 6.66V5.257Z" />
    <Path fill="#8C8CA1" d="M7.993 5.257 5.529 2.582 7.993 6.66V5.257Z" />
    <Path fill="#8C8CA1" d="M10.47 2.582H5.53l2.462 2.675 2.479-2.675Z" />
  </Svg>
);
