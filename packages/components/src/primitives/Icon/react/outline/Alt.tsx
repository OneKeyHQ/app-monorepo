...
const SvgAlt = (props: SvgProps) => (
  <Svg fill="none" viewBox="0 0 24 24" accessibilityRole="image" {...props}>
    ...
    <Path
      fill="currentColor"
      d="M5.71 15.104c-.56 0-.897-.32-.897-.851 0-.154.046-.378.125-.59l1.34-3.702c.257-.726.693-1.054 1.395-1.054.75 0 1.182.316 1.452 1.054l1.353 3.703c.083.228.117.394.117.585 0 .498-.37.855-.88.855-.52 0-.789-.237-.938-.818l-.104-.407h-1.95l-.105.378c-.166.602-.431.847-.909.847Zm1.344-2.536h1.25l-.623-2.175h-.033zM12.014 15c-.56 0-.88-.332-.88-.921v-4.25c0-.59.32-.922.88-.922s.88.332.88.922v3.768h1.656c.465 0 .776.253.776.702s-.303.701-.776.701zm4.819.104c-.56 0-.88-.332-.88-.922v-3.768h-.884c-.464 0-.776-.253-.776-.702s.303-.701.776-.701h3.528c.473 0 .776.253.776.701 0 .449-.31.702-.776.702h-.884v3.768c0 .59-.32.922-.88.922"
    />
  </Svg>
);
