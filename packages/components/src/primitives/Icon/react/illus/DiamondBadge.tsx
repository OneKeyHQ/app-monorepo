...
const SvgDiamondBadge = (props: SvgProps) => (
  <Svg fill="none" viewBox="0 0 20 20" accessibilityRole="image" {...props}>
    ...
    <Path
      fill="#E3E7ED"
      d="m4.365 8.556 1.298-2.084A1 1 0 0 1 6.512 6h6.976a1 1 0 0 1 .849.472l1.298 2.084a1 1 0 0 1-.054 1.136l-3.992 5.227a2 2 0 0 1-3.179 0L4.42 9.692a1 1 0 0 1-.055-1.136"
    />
    <Path
