...
const SvgStarBadge = (props: SvgProps) => (
  <Svg fill="none" viewBox="0 0 20 20" accessibilityRole="image" {...props}>
    ...
    <Path
      fill="#FFE5CF"
      d="M9.123 4.604a1 1 0 0 1 1.754 0l1.08 1.975a1 1 0 0 0 .693.503l2.211.417a1 1 0 0 1 .543 1.669l-1.544 1.637a1 1 0 0 0-.265.814l.287 2.232a1 1 0 0 1-1.42 1.032l-2.034-.963a1 1 0 0 0-.856 0l-2.034.963a1 1 0 0 1-1.42-1.032l.287-2.232a1 1 0 0 0-.265-.814L4.596 9.168a1 1 0 0 1 .542-1.67l2.212-.416a1 1 0 0 0 .692-.503z"
    />
    <Path
      stroke="url(#paint2_linear)"
      strokeOpacity={0.24}
      strokeWidth={0.5}
      d="M9.342 4.724a.75.75 0 0 1 1.316 0l1.08 1.975c.18.328.497.559.865.628l2.212.418a.75.75 0 0 1 .407 1.251l-1.544 1.638a1.25 1.25 0 0 0-.33 1.016l.286 2.233a.75.75 0 0 1-1.065.774l-2.035-.963a1.25 1.25 0 0 0-1.068 0l-2.035.963a.75.75 0 0 1-1.065-.774l.287-2.232a1.25 1.25 0 0 0-.33-1.017L4.777 8.996a.75.75 0 0 1 .407-1.251l2.212-.418c.368-.07.685-.3.865-.628z"
    />
    <Defs>
      <LinearGradient
        id="paint0_linear"
