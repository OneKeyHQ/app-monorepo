...
const SvgFolderDelete = (props: SvgProps) => (
  <Svg fill="none" viewBox="0 0 24 24" accessibilityRole="image" {...props}>
    <Path
      fill="currentColor"
      fillRule="evenodd"
      d="M2 6a3 3 0 0 1 3-3h3.93a3 3 0 0 1 2.496 1.336l.812 1.219A1 1 0 0 0 13.07 6H19a3 3 0 0 1 3 3v8a3 3 0 0 1-3 3H9.83a3 3 0 0 0-.594-3A3 3 0 0 0 5 12.764a3 3 0 0 0-3-.593z"
      clipRule="evenodd"
    />
    <Path
      fill="currentColor"
