...
const SvgFolderCloud = (props: SvgProps) => (
  <Svg fill="none" viewBox="0 0 24 24" accessibilityRole="image" {...props}>
    <Path
      fill="currentColor"
      d="M5 3a3 3 0 0 0-3 3v5.41a6.2 6.2 0 0 1 3.25-.91c1.673 0 3.192.659 4.311 1.725A5.5 5.5 0 0 1 12.901 20H19a3 3 0 0 0 3-3V9a3 3 0 0 0-3-3h-5.93a1 1 0 0 1-.832-.445l-.812-1.22A3 3 0 0 0 8.93 3z"
    />
    <Path
      fill="currentColor"
      fillRule="evenodd"
