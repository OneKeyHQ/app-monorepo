...
const SvgMagicStick = (props: SvgProps) => (
  <Svg fill="none" viewBox="0 0 24 24" accessibilityRole="image" {...props}>
    <Path
      fill="currentColor"
      fillRule="evenodd"
      d="M16.543 3.543a2.768 2.768 0 1 1 3.914 3.914l-13 13a2.768 2.768 0 1 1-3.914-3.914l13-13Zm2.5 1.414c-.3-.3-.786-.3-1.086 0L16.164 6.75l1.086 1.086 1.793-1.793c.3-.3.3-.786 0-1.086Z"
      clipRule="evenodd"
    />
    <Path
      fill="currentColor"
