...
const SvgCallOutgoing = (props: SvgProps) => (
  ...
  >
    ...
    <Path d="M16.023 3a.995.995 0 1 0 0 1.992h1.579L14.324 8.27a.996.996 0 0 0 1.408 1.407L19.01 6.4v1.58a.995.995 0 0 0 1.99 0V3.995A.995.995 0 0 0 20.005 3z" />
  </Svg>
);
