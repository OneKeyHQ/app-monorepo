...
const SvgFolderUser = (props: SvgProps) => (
  <Svg fill="none" viewBox="0 0 24 24" accessibilityRole="image" {...props}>
    <Path
      fill="currentColor"
      d="M2 6a3 3 0 0 1 3-3h3.93a3 3 0 0 1 2.496 1.336l.812 1.219A1 1 0 0 0 13.07 6H19a3 3 0 0 1 3 3v8a3 3 0 0 1-3 3h-6.126q0-.375-.095-.748a7.02 7.02 0 0 0-2.867-4.057A4.75 4.75 0 1 0 2 9.938zm0 9.063v.192l.088-.06z"
    />
    <Path
      fill="currentColor"
      fillRule="evenodd"
