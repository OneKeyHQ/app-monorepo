...
export const teal = generateSemanticColorsWithDefaultCount(
  'tealA',
  'teal',
  'light',
);

export const blue = generateSemanticColorsWithDefaultCount(
  'blueA',
  'blue',
  'light',
);
...
export const tealDark = generateSemanticColorsWithDefaultCount(
  'tealDarkA',
  'teal',
  'dark',
);
