...
public class RecoveryActivity extends AppCompatActivity {
    ...
    static {
        ...
        LOCALE_MAP.put("en", new String[]{"We hit a snag", "It looks like the app had trouble starting. A quick fix should get things back to normal.", "Export Logs", "Dismiss", "Quick Fix", "Repair Complete", "Error", "OK", "Failed to export logs", "Repair failed", "No log files found"});
        LOCALE_MAP.put("zh-CN", new String[]{"遇到了一点问题", "应用似乎未能正常启动，快速修复一下试试？", "导出日志", "没有问题", "快速修复", "修复完成", "错误", "确定", "导出日志失败", "修复失败", "未找到日志文件"});
        // Traditional Chinese — shared by zh-TW, zh-HK, zh-Hant
        LOCALE_MAP.put("zh-Hant", new String[]{"遇到了一點問題", "應用程式似乎未能正常啟動，快速修復一下試試？", "匯出日誌", "沒有問題", "快速修復", "修復完成", "錯誤", "確定", "匯出日誌失敗", "修復失敗", "未找到日誌檔案"});
        LOCALE_MAP.put("ja-JP", new String[]{"問題が発生しました", "アプリの起動がうまくいかなかったようです。クイック修復をお試しください。", "ログを書き出す", "問題ありません", "クイック修復", "修復完了", "エラー", "OK", "ログの書き出しに失敗しました", "修復に失敗しました", "ログファイルが見つかりません"});
        LOCALE_MAP.put("ko-KR", new String[]{"문제가 발생했어요", "앱이 정상적으로 시작되지 않은 것 같아요. 빠른 수리를 시도해 보세요.", "로그 내보내기", "문제없어요", "빠른 수리", "복구 완료", "오류", "확인", "로그 내보내기 실패", "복구 실패", "로그 파일을 찾을 수 없습니다"});
        LOCALE_MAP.put("de", new String[]{"Ein kleines Problem", "Die App scheint nicht richtig gestartet zu sein. Eine Schnellreparatur sollte helfen.", "Protokolle exportieren", "Kein Problem", "Schnellreparatur", "Reparatur abgeschlossen", "Fehler", "OK", "Protokollexport fehlgeschlagen", "Reparatur fehlgeschlagen", "Keine Protokolldateien gefunden"});
        LOCALE_MAP.put("es", new String[]{"Algo no salió bien", "Parece que la aplicación tuvo problemas al iniciarse. Una reparación rápida debería solucionarlo.", "Exportar registros", "No hay problema", "Reparación rápida", "Reparación completada", "Error", "OK", "Error al exportar registros", "Reparación fallida", "No se encontraron archivos de registro"});
        LOCALE_MAP.put("fr-FR", new String[]{"Un petit souci", "L'application semble avoir eu du mal à démarrer. Une réparation rapide devrait arranger les choses.", "Exporter les journaux", "Pas de problème", "Réparation rapide", "Réparation terminée", "Erreur", "OK", "Échec de l'exportation des journaux", "Échec de la réparation", "Aucun fichier journal trouvé"});
        LOCALE_MAP.put("it-IT", new String[]{"Un piccolo problema", "Sembra che l'app abbia avuto difficoltà ad avviarsi. Una riparazione rapida dovrebbe risolvere.", "Esporta log", "Nessun problema", "Riparazione rapida", "Riparazione completata", "Errore", "OK", "Esportazione log non riuscita", "Riparazione non riuscita", "Nessun file di log trovato"});
        LOCALE_MAP.put("pt", new String[]{"Um pequeno problema", "A aplicação parece ter tido dificuldades ao iniciar. Uma reparação rápida deverá resolver.", "Exportar registos", "Sem problema", "Reparação rápida", "Reparação concluída", "Erro", "OK", "Falha ao exportar registos", "Falha na reparação", "Nenhum ficheiro de registo encontrado"});
        LOCALE_MAP.put("pt-BR", new String[]{"Um pequeno problema", "O aplicativo parece ter tido dificuldades ao iniciar. Uma correção rápida deve resolver.", "Exportar logs", "Sem problema", "Correção rápida", "Reparo concluído", "Erro", "OK", "Falha ao exportar logs", "Falha no reparo", "Nenhum arquivo de log encontrado"});
        LOCALE_MAP.put("ru", new String[]{"Небольшая проблема", "Похоже, приложение не смогло нормально запуститься. Быстрое исправление должно помочь.", "Экспорт журналов", "Всё в порядке", "Быстрое исправление", "Восстановление завершено", "Ошибка", "OK", "Не удалось экспортировать журналы", "Не удалось выполнить восстановление", "Файлы журналов не найдены"});
        LOCALE_MAP.put("bn", new String[]{"একটু সমস্যা হয়েছে", "অ্যাপটি সঠিকভাবে চালু হতে পারেনি বলে মনে হচ্ছে। দ্রুত মেরামত করে দেখুন।", "লগ রপ্তানি", "সমস্যা নেই", "দ্রুত মেরামত", "মেরামত সম্পন্ন", "ত্রুটি", "ঠিক আছে", "লগ রপ্তানি ব্যর্থ", "মেরামত ব্যর্থ", "কোনো লগ ফাইল পাওয়া যায়নি"});
        LOCALE_MAP.put("hi-IN", new String[]{"एक छोटी सी समस्या", "ऐप सही से शुरू नहीं हो पाया लगता है। त्वरित मरम्मत से ठीक हो जाना चाहिए।", "लॉग निर्यात करें", "कोई समस्या नहीं", "त्वरित मरम्मत", "मरम्मत पूर्ण", "त्रुटि", "ठीक है", "लॉग निर्यात विफल", "मरम्मत विफल", "कोई लॉग फ़ाइल नहीं मिली"});
        LOCALE_MAP.put("id", new String[]{"Ada sedikit masalah", "Sepertinya aplikasi mengalami kendala saat memulai. Perbaikan cepat seharusnya bisa mengatasinya.", "Ekspor log", "Tidak masalah", "Perbaikan cepat", "Perbaikan selesai", "Kesalahan", "OK", "Gagal mengekspor log", "Perbaikan gagal", "File log tidak ditemukan"});
        LOCALE_MAP.put("th-TH", new String[]{"พบปัญหาเล็กน้อย", "ดูเหมือนแอปเริ่มต้นไม่สำเร็จ การซ่อมแซมด่วนน่าจะช่วยได้", "ส่งออกบันทึก", "ไม่มีปัญหา", "ซ่อมแซมด่วน", "ซ่อมแซมเสร็จสิ้น", "ข้อผิดพลาด", "ตกลง", "ส่งออกบันทึกไม่สำเร็จ", "ซ่อมแซมไม่สำเร็จ", "ไม่พบไฟล์บันทึก"});
        LOCALE_MAP.put("uk-UA", new String[]{"Невелика проблема", "Схоже, додаток не зміг нормально запуститися. Швидке виправлення має допомогти.", "Експорт журналів", "Все гаразд", "Швидке виправлення", "Відновлення завершено", "Помилка", "OK", "Не вдалося експортувати журнали", "Не вдалося виконати відновлення", "Файли журналів не знайдено"});
        LOCALE_MAP.put("vi", new String[]{"Gặp chút trục trặc", "Có vẻ ứng dụng gặp khó khăn khi khởi động. Sửa nhanh sẽ giúp mọi thứ trở lại bình thường.", "Xuất nhật ký", "Không sao", "Sửa nhanh", "Sửa chữa hoàn tất", "Lỗi", "OK", "Xuất nhật ký thất bại", "Sửa chữa thất bại", "Không tìm thấy tệp nhật ký"});
    }
