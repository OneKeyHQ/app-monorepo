...
private enum RecoveryStrings {
  static let localeMap: [String: RecoveryLocale] = [
    "en": RecoveryLocale(
      ...
      exportLogs: "Export Logs", tryAgain: "Dismiss", autoRepair: "Quick Fix",
    ...
    "zh-CN": RecoveryLocale(
      title: "遇到了一点问题",
      subtitle: "应用似乎未能正常启动，\n快速修复一下试试？",
      exportLogs: "导出日志", tryAgain: "没有问题", autoRepair: "快速修复",
    ...
    "zh-Hant": RecoveryLocale(
      ...
      exportLogs: "匯出日誌", tryAgain: "沒有問題", autoRepair: "快速修復",
    ...
    "ja-JP": RecoveryLocale(
      ...
      exportLogs: "ログを書き出す", tryAgain: "問題ありません", autoRepair: "クイック修復",
    ...
    "ko-KR": RecoveryLocale(
      ...
      exportLogs: "로그 내보내기", tryAgain: "문제없어요", autoRepair: "빠른 수리",
    ...
    "de": RecoveryLocale(
      ...
      exportLogs: "Protokolle exportieren", tryAgain: "Kein Problem", autoRepair: "Schnellreparatur",
    ...
    "es": RecoveryLocale(
      ...
      exportLogs: "Exportar registros", tryAgain: "No hay problema", autoRepair: "Reparación rápida",
    ...
    "fr-FR": RecoveryLocale(
      ...
      exportLogs: "Exporter les journaux", tryAgain: "Pas de problème", autoRepair: "Réparation rapide",
    ...
    "it-IT": RecoveryLocale(
      ...
      exportLogs: "Esporta log", tryAgain: "Nessun problema", autoRepair: "Riparazione rapida",
    ...
    "pt": RecoveryLocale(
      ...
      exportLogs: "Exportar registos", tryAgain: "Sem problema", autoRepair: "Reparação rápida",
    ...
    "pt-BR": RecoveryLocale(
      ...
      exportLogs: "Exportar logs", tryAgain: "Sem problema", autoRepair: "Correção rápida",
    ...
    "ru": RecoveryLocale(
      ...
      exportLogs: "Экспорт журналов", tryAgain: "Всё в порядке", autoRepair: "Быстрое исправление",
    ...
    "bn": RecoveryLocale(
      ...
      exportLogs: "লগ রপ্তানি", tryAgain: "সমস্যা নেই", autoRepair: "দ্রুত মেরামত",
    ...
    "hi-IN": RecoveryLocale(
      ...
      exportLogs: "लॉग निर्यात करें", tryAgain: "कोई समस्या नहीं", autoRepair: "त्वरित मरम्मत",
    ...
    "id": RecoveryLocale(
      ...
      exportLogs: "Ekspor log", tryAgain: "Tidak masalah", autoRepair: "Perbaikan cepat",
    ...
    "th-TH": RecoveryLocale(
      ...
      exportLogs: "ส่งออกบันทึก", tryAgain: "ไม่มีปัญหา", autoRepair: "ซ่อมแซมด่วน",
    ...
    "uk-UA": RecoveryLocale(
      ...
      exportLogs: "Експорт журналів", tryAgain: "Все гаразд", autoRepair: "Швидке виправлення",
    ...
    "vi": RecoveryLocale(
      ...
      exportLogs: "Xuất nhật ký", tryAgain: "Không sao", autoRepair: "Sửa nhanh",
