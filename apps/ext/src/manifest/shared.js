...
//
// Canonical IDs, origins and store listings: packages/shared/src/config/extensionConfig.ts.
// Keep its localDevelopment ID aligned when changing this manifest key.
