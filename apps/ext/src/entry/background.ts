...
// import  from '@onekeyhq/kit-bg/src/offscreens/instance/offscreenApiProxy';
// import { getExtensionInoffscreenApiProxydexHtml } from '@onekeyhq/kit/src/utils/extUtils.getHtml';
