...
{
  constructor(
    protected override iterator: INavigator<T>,
    fn: (item: T | null) => R,
  ) {
    super(iterator, fn);
  }
  ...
  current() {
    return this.fn(this.iterator.current());
  }
  previous() {
    return this.fn(this.iterator.previous());
  }
  parent() {
    return this.fn(this.iterator.parent());
  }
  first() {
    return this.fn(this.iterator.first());
  }
  last() {
    return this.fn(this.iterator.last());
  }
  override next() {
    return this.fn(this.iterator.next());
  }
