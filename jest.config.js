...
module.exports = async () => {
  ...
  return {
    ...
    transformIgnorePatterns: [
      'node_modules/(?!(react-native-reanimated|react-native-aes-crypto|@react-navigation/(core|routers)|@keystonehq/bc-ur-registry-eth|@mysten/(sui|bcs|utils)|@noble/hashes|@scure/(base|bip32|bip39)|timeout-signal|p-limit|yocto-queue)/)',
    ],
    transform: {
